...
@RestController
public class OathDemoApplication extends WebSecurityConfigurerAdapter {
	...
	public OAuth2UserService<OAuth2UserRequest, OAuth2User> oauth2UserService(WebClient rest) {
		...
		return request -> {
			...
			if (orgs.stream().anyMatch(org -> "shailkan".equals(org.get("login")))) {
				return user;
			}
